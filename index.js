document.addEventListener("DOMContentLoaded", function () {
  ...
  var loveMessage = document.querySelector(".love-message"); // Select the love message
  ...
  function toggleEnvelope() {
      if (!isOpen) {
          ...
          loveMessage.style.display = "block"; // Show love message when opened
  ...
  function closeEnvelope() {
      ...
      if (isOpen) {
          ...
          loveMessage.style.display = "none"; // Hide love message when closed
          isOpen = false;
      }
  }
});
